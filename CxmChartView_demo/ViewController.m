...
-(void)makeSmoothChartView{
    ...
    _smoothView = [[SmoothChartView alloc] initWithFrame:CGRectMake(30, 227/2, self.view.frame.size.width - 60,400)];
    _smoothView.gLineCount = 3;
    _smoothView.xLabelCount = 2;
    ...
    NSArray *pathY = @[@"33",@"27",@"8",@"38",@"30",@"45",@"40",@"48",@"22",@"7"];
    NSArray *pathY2 = @[@"27",@"8",@"38",@"30",@"45",@"40",@"48",@"22",@"7",@"19"];
    
    [_smoothView start];
    [_smoothView drawSmoothViewWithArrayX:pathX andArrayY:pathY andScaleX:12.0];
    [_smoothView drawSmoothViewWithArrayX2:pathX andArrayY:pathY2 andScaleX:12.0];
}
